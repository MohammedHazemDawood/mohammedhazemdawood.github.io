...
import { importObject, setWasmExports } from './PersonalWebsite-composeApp.import-object.mjs'
...
const wasmFilePath = './PersonalWebsite-composeApp.wasm';
...
try {
  ...
  if (isBrowser) {
    wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./PersonalWebsite-composeApp.wasm',import.meta.url).href), importObject, wasmOptions)).instance;
  }
} catch (e) {
